...
export function FAQ() {
  const items = [
    ...
    { q: "Dokumen apa saja yang didukung?", a: "Dokumen identitas: NPWP, Kartu Keluarga, ijazah, dan transkrip nilai. Dokumen transaksional: invoice, nota barang masuk / surat jalan, struk kasir, dan catatan stok harian. Paspor, SIM, dan akta kelahiran menyusul di v1.1." },
