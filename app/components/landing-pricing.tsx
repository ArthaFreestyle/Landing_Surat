  ...
  const plans = [
    {
      ...
      cta: "Mulai gratis",
      primary: false,
      features: ["3 dokumen / CV per bulan", "CV, dokumen & undangan digital", "Ekstensi Autofill (bonus)", "Preview & edit sebelum jadi", "Unduh PDF & Word"],
    },
    {
      name: "Pro",
      tagline: "Untuk yang sering bikin dokumen",
      price: { m: 49000, y: 39000 },
      cta: "Pilih Pro",
      primary: true,
      badge: "Paling populer",
      features: ["Dokumen, CV & undangan tanpa batas", "Semua tema & template surat", "Riwayat & template tersimpan", "Autofill Pro — 200 scan/bln", "Dukungan prioritas"],
    },
    {
      name: "Tim",
      tagline: "Untuk HR, koperasi, desa & UMKM",
      price: { m: 149000, y: 119000 },
      cta: "Hubungi kami",
      primary: false,
      features: ["Scan tak terbatas", "Template surat bersama tim", "Akses API", "Penagihan terpusat & admin", "Onboarding tim"],
    },
  ];
